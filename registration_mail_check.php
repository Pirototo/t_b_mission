...
if (count($errors) === 0){
	...
	$url = "http://co-155.99sv-coco.com/mission5~6_Suzuki/registration_form.php"."?urltoken=".$urltoken;
	...
	$name = "English test for intermediate";
	$mail = 'メールアドレス';
...
EOM;
	...
	if (mb_send_mail($mailTo, $subject, $body, '-f'. $returnMail)) {
